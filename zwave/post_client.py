...
Get all measures for a given node
    ...
    post_client.py sensor readings -n 2


Print a specfic field from the JSON responseGet all measures for a given node

    post_client.py sensor readings -n 2 -f updateTime
